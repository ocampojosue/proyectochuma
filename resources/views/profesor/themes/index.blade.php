...
<div class="container-fluid">
   <div class="row">
      ...
      <div class="col-6">
         <a href="{{route('profesor.themes.create')}}" class="btn btn-primary float-right">NUEVO TEMA</a>
      </div>
   </div>
   <br>
   <div class="card">
         ...
         <table id="themes" class="table table striped shadow-lg mt-4">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td width="150px">
                     <form action="{{route('profesor.themes.destroy',$theme)}}" method="POST">
                        <a href="{{route('profesor.themes.edit',$theme)}}" class="btn btn-primary btn-sm">Editar</a>
                        @method('delete')
                        @csrf
